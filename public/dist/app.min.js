...
/* WEBPACK VAR INJECTION */(function(global) {/* http://prismjs.com/download.html?themes=prism-coy&languages=clike */
...
exports.default = {
    ...
    methods: {
        /** @param {Event} event */
        checkButton: function checkButton(event) {
        ...
        onNewChar: function onNewChar(event) {
            var _this2 = this;

            var prefix = this.getPrefix(event);
        ...
        doExec: function doExec() {
            ...
            this.$http.post('/try-online', {
                ...
                if (response.data.result) {
                    _this3.error = '';
                    _this3.result = _Prism2.default.highlight(response.data.result, _Prism2.default.languages.json);
                } else {
                    _this3.result = '';
        ...
        getPrefix: function getPrefix(event) {
        ...
        render: function render(event) {
            ...
            var contentBefore = this.getPrefix(event);
...
var render = function() {
  ...
  return _c("section", { staticClass: "page-try-online" }, [
    _c("article", { staticClass: "column" }, [
      _c("div", { staticClass: "editor" }, [
        _c(
          "div",
          {
            staticClass: "code-block-render",
            style: { top: _vm.scrollTop + "px" }
          },
          [
            _c("div", {
    ...
    _c(
      ...
      [
        _vm.loading ? _c("ui-loading") : _vm._e(),
        _vm.error
          ? _c("output", { staticClass: "code-value-error" }, [
