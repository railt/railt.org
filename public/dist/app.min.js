...
var toPrimitive = __webpack_require__(400);
var dP = Object.defineProperty;
...
var lib = __webpack_require__(165);
...
vue_default.a.use(vue_axios_min_default.a, axios_default.a);
...
for (let name of Object.keys(components)) {
    ...
    vue_default.a.component(name, __webpack_require__(390)(`./${component}.vue`));
}
...
for (let name of Object.keys(partials)) {
    ...
    vue_default.a.component(name, __webpack_require__(455)(`./${partial}.vue`));
}
...
for (let name of Object.keys(pages)) {
    let page = pages[name];
    vue_default.a.component(name, __webpack_require__(460)(`./${page}.vue`));
}

window.app = new vue_default.a({
    el: 'main',
    mounted: function () {
...
var anObject = __webpack_require__(72);
var get = __webpack_require__(437);
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("header", [
    _c("section", { staticClass: "header-content" }, [
      _c(
        "nav",
        [
          _vm.searchText.length === 0 ? [_vm._t("default")] : _vm._e(),
          _vm.searchEnable
            ? _c(
                "div",
                { staticClass: "search" },
...
var _Prism = __webpack_require__(464);
  ...
  return _c("section", { staticClass: "page-donate" }, [
    _c(
      ...
      [
        ...
        _c("input", {
          attrs: { type: "hidden", name: "formcomment" },
