...
var vue_min = __webpack_require__(388);
...
for (let name of Object.keys(components)) {
    ...
    vue_min_default.a.component(name, __webpack_require__(390)(`./${component}.vue`));
}
...
for (let name of Object.keys(partials)) {
    ...
    vue_min_default.a.component(name, __webpack_require__(455)(`./${partial}.vue`));
}
...
for (let name of Object.keys(pages)) {
    let page = pages[name];
    vue_min_default.a.component(name, __webpack_require__(460)(`./${page}.vue`));
}
