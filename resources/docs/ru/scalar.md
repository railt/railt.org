...
- [Описание](/scalar#описание)
- [Стандартные типы](/scalar#стандартные-типы)
    - [Int](/scalar#int)
    - [Float](/scalar#float)
    ...
    - [ID](/scalar#id)
    - [Any](/scalar#any)
- [Иерархия типов](/scalar#иерархия-типов)
- [Модификаторы](/scalar#модификаторы)
    - [List](/scalar#list)
    - [Non-Null](/scalar#non-null)
- [Соответсвие скалярам PHP](/scalar#соответсвие-скалярам-php)
- [Пользовательские типы](/scalar#пользовательские-типы)
    - [Roadmap](/scalar#roadmap)
...
в качестве значения для типа [`String`](/scalar#string).

#### Приведение ID в ответах

Поведение типа `ID` во время сериализации полностью повторяет 
поведение типа [`String`](/scalar#string).
