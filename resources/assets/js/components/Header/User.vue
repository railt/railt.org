<template>
    <app-auth>
            ...
            <template slot="auth" slot-scope="{ user }">
                <button @click="accountDropdown = !accountDropdown" class="user-badge">
                    <span class="user-badge-login">{{ user.login }}</span>
                    <img class="user-badge-avatar" :src="user.avatar" :alt="user.login"/>
