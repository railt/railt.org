/* http://prismjs.com/download.html?themes=prism&plugins=line-numbers */
...
Prism.languages.graphql = {
    ...
    'variable': /\b(?:ID|Int|Float|String|Boolean|Any|DateTime)\b/i,
    'directive': {
        pattern: /@[a-z_]\w*/i,
        alias: 'function'
    },
    ...
    'keyword': [
        ...
        /\b(?:query|fragment|mutation|type|implements|enum|union|interface|schema|scalar|directive|input|extend)\b/
    ],
    'operator': /=|\.{3}/,
    'punctuation': /[!(){}:=,]/
};
